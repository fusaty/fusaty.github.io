...
var laserMusic = new Audio('/sounds/39459__THE_bizniss__laser.mp3');
var explosionMusic = new Audio('/sounds/51467__smcameron__missile_explosion.wav');
var deathMusic = new Audio('/sounds/arcade-retro-game-over-213.wav');
...
Sprite = function () {
  ...
  this.draw = function () {
    ...
    this.context.fillStyle = 10, 53, 0, 170;
...
SFX = {
  laser:     new Audio('/sounds/39459__THE_bizniss__laser.mp3'),
  explosion: new Audio('/sounds/51467__smcameron__missile_explosion.wav')
};
